...
echo "[1/11] Instalando dependências..."
sudo apt-get update
...
echo "[5/11] Instalando dependências Node..."
cd "$APP_DIR/app"
...
echo "[6/11] Instalando arquivos auxiliares..."
...
echo "[11/11] Habilitando serviço..."
